...
- [`ns-simulator-docs/specs/edge-properties-and-defaults.md`](./edge-properties-and-defaults.md): current edge transfer pipeline and unsupported edge capacity fields.
- [`ns-simulator-docs/specs/request-flow-direction-and-topology-rules.md`](./request-flow-direction-and-topology-rules.md): routing, fan-out, weights, and conditional edge selection.
- [`ns-simulator-docs/specs/request-pattern-configuration.md`](./request-pattern-configuration.md): implemented workload pattern algorithms.
