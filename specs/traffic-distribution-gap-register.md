...
goal. **Update (2026-09-11):** consistent hashing for Tier-4 key routers is **done**
— `pickOnHashRing` extracted to `core/hashRing.ts` (with a MurmurHash3 avalanche
...
**Update (2026-09-11):** the `stream` broker canvas-serialization gap is **closed**
— `streamBrokerEnabled`, `partitionCount`, `partitionKeyField`, `retentionMs`,
